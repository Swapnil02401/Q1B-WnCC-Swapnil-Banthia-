...
projDetails = []
projDetails.append(fields)

s = soup.find('div', class_='row row-eq-height shuffle-wrapper shuffle')
...
df = pd.DataFrame(projDetails)
df.to_csv('soc_projects.csv', header=False, index=False)
# name of csv file 
